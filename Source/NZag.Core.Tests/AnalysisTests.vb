    ...
    Sub Zork1_4E3B_ControlFlow()
        ...
        Dim expected =
            ControlFlowGraph(
                ...
                ControlFlowBlock(0, Pred(Graphs.Entry), Succ(1)),
                ControlFlowBlock(1, Pred(0), Succ(Graphs.Exit)),
                ControlFlowBlock(Graphs.Exit, Pred(1), NoSucc))
    ...
    Sub Zork1_4E42_ControlFlow()
        ...
        Dim expected =
            ControlFlowGraph(
                ControlFlowBlock(Graphs.Entry, NoPred, Succ(0)),
                ControlFlowBlock(0, Pred(Graphs.Entry), Succ(1)),
                ControlFlowBlock(1, Pred(0), Succ(2, 7)),
                ControlFlowBlock(2, Pred(1), Succ(3, 4)),
                ControlFlowBlock(3, Pred(2), Succ(5)),
                ControlFlowBlock(4, Pred(2), Succ(5)),
                ControlFlowBlock(5, Pred(3, 4), Succ(Graphs.Exit, 6)),
                ControlFlowBlock(6, Pred(5), Succ(Graphs.Exit)),
                ControlFlowBlock(7, Pred(1), Succ(8, 9)),
                ControlFlowBlock(8, Pred(7), Succ(10)),
                ControlFlowBlock(9, Pred(7), Succ(10)),
                ControlFlowBlock(10, Pred(8, 9), Succ(Graphs.Exit, 11)),
                ControlFlowBlock(11, Pred(10), Succ(Graphs.Exit)),
                ControlFlowBlock(Graphs.Exit, Pred(5, 6, 10, 11), NoSucc))
