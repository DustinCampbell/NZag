...
LABEL 00
    ...
    if (temp00 = 0) is true then
        jump-to: LABEL 04
LABEL 01
    if (((read-byte(904) & 10) <> 0) = 1) is false then
        jump-to: LABEL 03
LABEL 02
    return: 39
LABEL 03
...
LABEL 09
    ...
    if (((read-byte(((temp19 - 1) * 9) + 2ee) & 10) <> 0) = 1) is true then
        jump-to: LABEL 0b
LABEL 0a
    push-SP: call 6ee0 ()
    print: "\n"
...
LABEL 31
    if (temp1e = 0b) is false then
        jump-to: LABEL 33
LABEL 32
    write-word(2365) <- (int16(read-word(2365)) + int16(1))
    jump-to: LABEL 1a
LABEL 33
    temp25 <- read-word(2361)
    if (temp25 = 5d) is false then
        jump-to: LABEL 38
LABEL 34
    temp26 <- read-word(235f)
    if (temp26 = 0) is true then
        jump-to: LABEL 38
LABEL 35
    temp27 <- read-word(2339)
    temp28 <- read-word(temp27 + c)
    temp29 <- read-word(temp28)
    if (temp29 = 3b7c) is false then
        jump-to: LABEL 38
LABEL 36
    temp2a <- read-word(235d)
    temp2b <- read-word(235f)
    if (read-byte((((temp2a - 1) * 9) + 2ee) + 4) = temp2b) is true then
        jump-to: LABEL 38
LABEL 37
    jump-to: LABEL 1a
LABEL 38
    temp2c <- read-word(2311)
    if (temp2c = 01) is false then
        jump-to: LABEL 3f
LABEL 39
    temp2d <- read-word(2361)
    if (temp2d = 5d) is false then
        jump-to: LABEL 3f
LABEL 3a
    temp2e <- read-byte((((temp1e - 1) * 9) + 2ee) + 4)
    temp2f <- read-word(234f)
    temp30 <- read-word(2271)
    if ((temp2e = temp2f) | (temp2e = temp30)) is true then
        jump-to: LABEL 3c
LABEL 3b
    temp31 <- read-byte((((temp1e - 1) * 9) + 2ee) + 4)
    if (((read-byte((((temp31 - 1) * 9) + 2ee) + 1) & 20) <> 0) = 1) is false then
        jump-to: LABEL 1a
LABEL 3c
    if (((read-byte((((temp1e - 1) * 9) + 2ee) + 2) & 40) <> 0) = 1) is true then
        jump-to: LABEL 3f
LABEL 3d
    if (((read-byte((((temp1e - 1) * 9) + 2ee) + 1) & 4) <> 0) = 1) is true then
        jump-to: LABEL 3f
LABEL 3e
    jump-to: LABEL 1a
LABEL 3f
    if (temp1e = 0c) is false then
        jump-to: LABEL 41
LABEL 40
    temp32 <- read-word(2347)
    temp33 <- read-word((((temp32 - 1) * 9) + 2ee) + 7)
    print: read-text(temp33 + 1, read-byte(temp33))
    jump-to: LABEL 42
LABEL 41
    temp34 <- read-word((((temp1e - 1) * 9) + 2ee) + 7)
    print: read-text(temp34 + 1, read-byte(temp34))
LABEL 42
    print: ": "
LABEL 43
    temp17 <- 01
    temp35 <- read-word(2361)
    temp36 <- read-word(235d)
    temp37 <- read-word(235f)
    temp00 <- call 577c (temp35, temp36, temp37)
...
LABEL 45
    if (temp00 = 02) is true then
        jump-to: LABEL 53
LABEL 46
    temp38 <- read-word(234f)
    temp39 <- read-byte((((temp38 - 1) * 9) + 2ee) + 4)
    temp3a <- read-word((((temp39 - 1) * 9) + 2ee) + 7)
    temp3b <- uint16((temp3a + 1) + (read-byte(temp3a) * 2))
    temp3c <- 0
LABEL 47
    temp3d <- read-byte(temp3b)
    if ((temp3d & 1f) <= 11) is false then
        jump-to: LABEL 49
LABEL 48
    temp3c <- 1
    jump-to: LABEL 4a
LABEL 49
    temp3e <- read-byte(temp3b)
    temp3b <- uint16((temp3b + 1) + ((temp3e >> 5) + 1))
LABEL 4a
    if (temp3c = 0) is true then
        jump-to: LABEL 47
    if ((temp3d & 1f) = 11) is false then
        jump-to: LABEL 4f
LABEL 4b
    temp3b <- (temp3b + 1)
    if ((temp3d & e0) = 0) is false then
        jump-to: LABEL 4d
LABEL 4c
    temp3f <- read-byte(temp3b)
    jump-to: LABEL 4e
LABEL 4d
    temp3f <- read-word(temp3b)
LABEL 4e
    jump-to: LABEL 50
LABEL 4f
    temp3f <- read-word(2d0)
LABEL 50
...
LABEL 51
    ...
    jump-to: LABEL 53
LABEL 52
    temp00 <- call (temp3f * 2) (06)
LABEL 53
    temp40 <- read-word(2361)
    if (((temp40 = 08) | (temp40 = 89)) | (temp40 = 0f)) is true then
        jump-to: LABEL 57
LABEL 54
    temp41 <- read-word(2361)
    if (((temp41 = 0c) | (temp41 = 09)) | (temp41 = 07)) is false then
        jump-to: LABEL 56
LABEL 55
    jump-to: LABEL 57
LABEL 56
    temp42 <- read-word(2361)
    write-word(236d) <- temp42
    temp43 <- read-word(235d)
    write-word(236b) <- temp43
    temp44 <- read-word(235f)
    write-word(2369) <- temp44
LABEL 57
    if (temp00 = 02) is false then
        jump-to: LABEL 5a
LABEL 58
...
LABEL 59
    write-word(2349) <- 00
LABEL 5a
    temp45 <- read-word(236f)
    if (temp45 = 0) is true then
        jump-to: LABEL 01
LABEL 5b
    temp46 <- read-word(2361)
    if (((temp46 = 02) | (temp46 = 01)) | (temp46 = 6f)) is true then
        jump-to: LABEL 01
LABEL 5c
    temp47 <- read-word(2361)
    if (((temp47 = 0c) | (temp47 = 08)) | (temp47 = 00)) is true then
        jump-to: LABEL 01
LABEL 5d
    temp48 <- read-word(2361)
    if (((temp48 = 09) | (temp48 = 06)) | (temp48 = 05)) is true then
        jump-to: LABEL 01
LABEL 5e
    temp49 <- read-word(2361)
    if (((temp49 = 07) | (temp49 = 0b)) | (temp49 = 0a)) is false then
        jump-to: LABEL 60
LABEL 5f
    jump-to: LABEL 01
LABEL 60
...
LABEL 07
    ...
    if (((read-byte(((temp06 - 1) * 9) + 2ee) & 10) <> 0) = 1) is true then
        jump-to: LABEL 09
LABEL 08
    temp07 <- read-word(2271)
    temp08 <- (((temp07 - 1) * 9) + 2ee)
    write-byte(temp08) <- byte(read-byte(temp08) | 10)
    temp03 <- 01
LABEL 09
    temp09 <- read-word(2271)
    if (((read-byte(((temp09 - 1) * 9) + 2ee) & 4) <> 0) = 1) is false then
        jump-to: LABEL 0b
LABEL 0a
    temp0a <- read-word(2271)
    temp0b <- (((temp0a - 1) * 9) + 2ee)
    write-byte(temp0b) <- byte(read-byte(temp0b) & not 10)
LABEL 0b
...
LABEL 0c
    ...
    if (((read-byte((((temp10 - 1) * 9) + 2ee) + 3) & 10) <> 0) = 1) is false then
        jump-to: LABEL 0e
LABEL 0d
    print: ", in the "
...
LABEL 01
    if (((read-byte(6e7) & 1) <> 0) = 1) is true then
        jump-to: LABEL 03
LABEL 02
    push-SP: 01
    jump-to: LABEL 04
...
LABEL 0b
    ...
    if (temp02 = temp06) is false then
        jump-to: LABEL 11
LABEL 0c
    if (((read-byte((((temp02 - 1) * 9) + 2ee) + 2) & 8) <> 0) = 1) is true then
        jump-to: LABEL 11
LABEL 0d
    temp07 <- read-word(2271)
...
LABEL 0e
    ...
    if (temp08 = 0) is false then
        return: 1
LABEL 0f
    if (((read-byte(6e7) & 1) <> 0) = 1) is false then
        jump-to: LABEL 1a
LABEL 10
    temp04 <- 00
    jump-to: LABEL 1a
...
LABEL 12
    if (((read-byte(6e7) & 1) <> 0) = 1) is true then
        jump-to: LABEL 14
LABEL 13
    write-byte(6e7) <- byte(read-byte(6e7) | 1)
    temp04 <- 00
LABEL 14
    if (((read-byte(((temp02 - 1) * 9) + 2ee) & 10) <> 0) = 1) is false then
        jump-to: LABEL 1a
LABEL 15
    push-SP: call 103b8 (temp02, 72, 4b)
    if (((read-byte(((temp02 - 1) * 9) + 2ee) & 4) <> 0) = 1) is false then
        jump-to: LABEL 18
LABEL 16
    temp09 <- read-word(2271)
    if (((read-byte(((temp09 - 1) * 9) + 2ee) & 4) <> 0) = 1) is false then
...
LABEL 23
    ...
    if (read-byte(5cd) <> 0) is true then
        jump-to: LABEL 24
LABEL 24
    if (((read-byte((((temp02 - 1) * 9) + 2ee) + 1) & 40) <> 0) = 1) is true then
        jump-to: LABEL 20
LABEL 25
    if (((read-byte(((temp02 - 1) * 9) + 2ee) & 2) <> 0) = 1) is false then
        jump-to: LABEL 20
LABEL 26
    temp0d <- temp02
    temp0e <- 0
...
LABEL 35
    write-byte(6e7) <- byte(read-byte(6e7) & not 20)
    write-byte(6e7) <- byte(read-byte(6e7) | 1)
    write-word(22af) <- 00
    jump-to: LABEL 01
LABEL 36
